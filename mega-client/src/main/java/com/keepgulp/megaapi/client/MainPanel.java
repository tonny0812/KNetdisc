...
public final class MainPanel {
    ...
    public void loadUserSettings() {
        ...
        if (max_downloads != null) {
            ...
            _max_dl = SIM_TRANSFERENCES_DEFAULT;
        }
        ...
        if (max_uploads != null) {
            ...
            _max_ul = SIM_TRANSFERENCES_DEFAULT;
        }
                            ...
                            if (!_upload_manager.getTransference_running_list().isEmpty()) {
                                ...
                                for (Transference trans : _upload_manager.getTransference_running_list()) {
                                    ...
                                    if (!upload.getChunkworkers().isEmpty()) {
                                        ...
                                        try {
                                            updateUploadProgress(upload.getFile_name(), upload.getMa().getFull_email(), upload.getProgress(), upload.getFile_meta_mac() != null ? Bin2BASE64(i32a2bin(upload.getFile_meta_mac())) : null);
                                        } catch (SQLException ex) {
                                            Logger.getLogger(MainPanel.class.getName()).log(Level.SEVERE, null, ex);
                                        }
                                    }
