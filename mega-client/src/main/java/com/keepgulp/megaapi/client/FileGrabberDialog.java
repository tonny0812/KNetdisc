...
public final class FileGrabberDialog extends javax.swing.JDialog implements FileDropHandlerNotifiable {
    ...
    private void initComponents() {
        ...
        dir_name_textfield = new JTextField();
        ...
        upload_log_checkbox = new JCheckBox();
        ...
        file_tree.setModel(new DefaultTreeModel(treeNode1));
        ...
        dance_button.setBackground(new Color(102, 204, 255));
        dance_button.setFont(new java.awt.Font("Dialog", 1, 22)); // NOI18N
        dance_button.setForeground(new Color(255, 255, 255));
