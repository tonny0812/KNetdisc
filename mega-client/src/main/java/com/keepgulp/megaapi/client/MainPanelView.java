...
public final class MainPanelView extends javax.swing.JFrame implements FileDropHandlerNotifiable {
                ...
                while (true) {
                    ...
                    swingInvoke(new Runnable() {
                        ...
                        public void run() {
                            ...
                            memory_status.setText(formatBytes(instance.totalMemory() - instance.freeMemory()) + " / " + formatBytes(instance.maxMemory()));
    ...
    private void initComponents() {
        ...
        kiss_server_status = new JLabel();
        mc_reverse_status = new JLabel();
        smart_proxy_status = new JLabel();
        memory_status = new JLabel();
        jTabbedPane1 = new JTabbedPane();
        downloads_panel = new JPanel();
        global_speed_down_label = new JLabel();
        status_down_label = new JLabel();
        close_all_finished_down_button = new JButton();
        jScrollPane_down = new javax.swing.JScrollPane();
        jPanel_scroll_down = new JPanel();
        pause_all_down_button = new JButton();
        down_remtime_label = new JLabel();
        uploads_panel = new JPanel();
        global_speed_up_label = new JLabel();
        status_up_label = new JLabel();
        close_all_finished_up_button = new JButton();
        jScrollPane_up = new javax.swing.JScrollPane();
        jPanel_scroll_up = new JPanel();
        pause_all_up_button = new JButton();
        up_remtime_label = new JLabel();
        unfreeze_transferences_button = new JButton();
        main_menubar = new javax.swing.JMenuBar();
        file_menu = new javax.swing.JMenu();
        new_download_menu = new JMenuItem();
        new_upload_menu = new JMenuItem();
        new_stream_menu = new JMenuItem();
        jSeparator5 = new javax.swing.JPopupMenu.Separator();
        split_file_menu = new JMenuItem();
        merge_file_menu = new JMenuItem();
        jSeparator4 = new javax.swing.JPopupMenu.Separator();
        clean_all_down_menu = new JMenuItem();
        clean_all_up_menu = new JMenuItem();
        jSeparator2 = new javax.swing.JPopupMenu.Separator();
        hide_tray_menu = new JMenuItem();
        auto_close_menu = new JCheckBoxMenuItem();
        exit_menu = new JMenuItem();
        edit_menu = new javax.swing.JMenu();
        settings_menu = new JMenuItem();
        help_menu = new javax.swing.JMenu();
        about_menu = new JMenuItem();

        setTitle("MegaBasterd " + VERSION);
        setIconImage(new ImageIcon(getClass().getResource(ICON_FILE)).getImage());

        logo_label.setIcon(new ImageIcon(getClass().getResource("/images/mbasterd_logo_nuevo-picsay.png"))); // NOI18N
        logo_label.setDoubleBuffered(true);

        kiss_server_status.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        kiss_server_status.setForeground(new Color(102, 102, 102));
        kiss_server_status.setDoubleBuffered(true);

        mc_reverse_status.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        mc_reverse_status.setForeground(new Color(102, 102, 102));

        smart_proxy_status.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        smart_proxy_status.setForeground(new Color(102, 102, 102));
        smart_proxy_status.setDoubleBuffered(true);

        memory_status.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        memory_status.setForeground(new Color(102, 102, 102));
        ...
        status_down_label.setForeground(new Color(102, 102, 102));
        status_down_label.setDoubleBuffered(true);

        close_all_finished_down_button.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        close_all_finished_down_button.setIcon(new ImageIcon(getClass().getResource("/images/icons8-ok-30.png"))); // NOI18N
        ...
        jScrollPane_down.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)));
        ...
        pause_all_down_button.setBackground(new Color(255, 153, 0));
        pause_all_down_button.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        pause_all_down_button.setForeground(new Color(255, 255, 255));
        ...
        jTabbedPane1.addTab("Downloads", new ImageIcon(getClass().getResource("/images/icons8-download-from-ftp-30.png")), downloads_panel); // NOI18N
        ...
        status_up_label.setForeground(new Color(102, 102, 102));

        close_all_finished_up_button.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        close_all_finished_up_button.setIcon(new ImageIcon(getClass().getResource("/images/icons8-ok-30.png"))); // NOI18N
        ...
        jScrollPane_up.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)));
        ...
        pause_all_up_button.setBackground(new Color(255, 153, 0));
        pause_all_up_button.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        pause_all_up_button.setForeground(new Color(255, 255, 255));
        ...
        jTabbedPane1.addTab("Uploads", new ImageIcon(getClass().getResource("/images/icons8-upload-to-ftp-30.png")), uploads_panel); // NOI18N

        unfreeze_transferences_button.setBackground(new Color(255, 255, 255));
        unfreeze_transferences_button.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        unfreeze_transferences_button.setForeground(new Color(0, 153, 255));
        ...
        new_download_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-download-from-ftp-30.png"))); // NOI18N
        ...
        new_upload_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-upload-to-ftp-30.png"))); // NOI18N
        ...
        new_stream_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-video-playlist-30.png"))); // NOI18N
        ...
        split_file_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-cut-30.png"))); // NOI18N
        ...
        merge_file_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-glue-30.png"))); // NOI18N
        ...
        clean_all_down_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-trash-can-30.png"))); // NOI18N
        ...
        clean_all_up_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-trash-can-30.png"))); // NOI18N
        ...
        auto_close_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-cancel-30.png"))); // NOI18N
        ...
        exit_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-shutdown-30.png"))); // NOI18N
        ...
        settings_menu.setIcon(new ImageIcon(getClass().getResource("/images/icons8-services-30.png"))); // NOI18N
                ...
                public void run() {
                    ...
                    for (String link : elc) {
                        ...
                        try {
                            ...
                            urls.addAll(decryptELC(link, getMain_panel()));
                    ...
                    for (String d : dlc) {
                        ...
                        Set<String> links = decryptDLC(d, _main_panel);
    ...
    private void settings_menuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_settings_menuActionPerformed
        ...
        if (dialog.isSettings_ok()) {
            ...
            if (_main_panel.isRestart()) {
                ...
                if (isUse_smart_proxy()) {

                    if (getProxy_manager() == null) {
                        setProxy_manager(new SmartMegaProxyManager(null, _main_panel));
                    }

                    getProxy_manager().refreshProxyList();

                    updateSmartProxyStatus("SmartProxy: ON (" + String.valueOf(getProxy_manager().getProxyCount()) + ")");
    ...
    private void auto_close_menuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_auto_close_menuActionPerformed
        try {
            insertSettingValue("auto_close", getAuto_close_menu().isSelected() ? "yes" : "no");
        } catch (SQLException ex) {
            Logger.getLogger(MainPanelView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private JLabel mc_reverse_status;
