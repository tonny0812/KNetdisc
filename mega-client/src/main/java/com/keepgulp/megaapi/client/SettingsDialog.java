...
public final class SettingsDialog extends javax.swing.JDialog {
    ...
    public SettingsDialog(MainPanelView parent, boolean modal) {
        ...
        String megacrypter_reverse_p = String.valueOf(DEFAULT_MEGA_PROXY_PORT);
    ...
    private void initComponents() {
        ...
        default_slots_down_spinner = new JSpinner();
        megacrypter_reverse_port_spinner = new JSpinner();
        ...
        default_slots_up_spinner = new JSpinner();
        max_uploads_spinner = new JSpinner();
        max_up_speed_label = new javax.swing.JLabel();
        max_up_speed_spinner = new JSpinner();
        ...
        mega_accounts_table.setModel(new DefaultTableModel(
                new Object[][]{
        ...
        elc_accounts_table.setModel(new DefaultTableModel(
                new Object[][]{
                ...
                for (int i = 0; i < model.getRowCount(); i++) {
                    ...
                    if (!host_table.isEmpty() && !user_table.isEmpty() && !apikey_table.isEmpty()) {
                        ...
                        if (_main_panel.getElc_accounts().get(host_table) == null) {
                            ...
                            insertELCAccount(host_table, user_table, apikey_table);
                            ...
                            if (!user.equals(user_table) || !apikey.equals(apikey_table)) {
                                ...
                                insertELCAccount(host_table, user, apikey);
                            }
                        }
                    }
                }
                                    ...
                                    try {
                                        ...
                                        if (!error_2FA) {
                                            ...
                                            if (_main_panel.getMaster_pass() != null) {
                                                ...
                                                insertMegaSession(email, CryptTools.aes_cbc_encrypt_pkcs7(bs.toByteArray(), _main_panel.getMaster_pass(), CryptTools.AES_ZERO_IV), true);

                                            } else {

                                                insertMegaSession(email, bs.toByteArray(), false);
                                            }
                                            ...
                                            insertMegaAccount(email, password, password_aes, user_hash);
                                        } else {
    ...
    private void import_settings_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_import_settings_buttonActionPerformed
        ...
        int n = showOptionDialog(this,
                ...
                LabelTranslatorSingleton.getInstance().translate("IMPORT SETTINGS"), YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE,
                null,
                options,
                options[0]);
    ...
    private void export_settings_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_export_settings_buttonActionPerformed
        ...
        int n = showOptionDialog(this,
                ...
                LabelTranslatorSingleton.getInstance().translate("EXPORT SETTINGS"), YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE,
                null,
                options,
                options[0]);
    ...
    private void delete_all_accounts_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_all_accounts_buttonActionPerformed
        ...
        int n = showOptionDialog(this,
                ...
                LabelTranslatorSingleton.getInstance().translate("RESET ACCOUNTS"), YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE,
                null,
                options,
                options[0]);
        ...
        if (n == 1) {
            ...
            try {
                ...
                truncateMegaAccounts();

                truncateELCAccounts();

                truncateMegaSessions();
                ...
                if (dialog.isPass_ok()) {
                    ...
                    try {
                        ...
                        for (Map.Entry pair : _main_panel.getElc_accounts().entrySet()) {
                            ...
                            insertELCAccount(host, user, apikey);
                        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int n = showOptionDialog(this,
                ...
                LabelTranslatorSingleton.getInstance().translate("RESET MEGABASTERD"), YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE,
                null,
                options,
                options[0]);
    ...
    private JSpinner default_slots_down_spinner;
    private javax.swing.JLabel default_slots_up_label;
    private JSpinner default_slots_up_spinner;
    ...
    private JSpinner max_down_speed_spinner;
    private javax.swing.JLabel max_downloads_label;
    private JSpinner max_downloads_spinner;
    private javax.swing.JLabel max_up_speed_label;
    private JSpinner max_up_speed_spinner;
    private javax.swing.JLabel max_uploads_label;
    private JSpinner max_uploads_spinner;
    ...
    private JSpinner megacrypter_reverse_port_spinner;
