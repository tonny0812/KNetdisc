package com.keepgulp.megaapi.kits;

import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.keepgulp.megaapi.client.MainPanel;
import com.keepgulp.megaapi.client.MegaAPIException;
import com.keepgulp.megaapi.client.MiscTools;
import com.keepgulp.megaapi.client.Transference;
...
import static com.keepgulp.megaapi.kits.MiscTools.*;
import static com.keepgulp.megaapi.kits.CryptTools.*;
...
public final class MegaAPI implements Serializable {
    ...
    public void login(String email, String password, String pincode) throws Exception {
        ...
        if (_account_version == 1) {
            ...
            byte[] pbkdf2_key = PBKDF2HMACSHA512(password, UrlBASE642Bin(_salt), PBKDF2_ITERATIONS, PBKDF2_OUTPUT_BIT_LENGTH);

            _password_aes = bin2i32a(Arrays.copyOfRange(pbkdf2_key, 0, 16));

            _user_hash = Bin2UrlBASE64(Arrays.copyOfRange(pbkdf2_key, 16, 32));
        }
                ...
                if (http_error == 509 && !MainPanel.isUse_proxy()) {
                    ...
                    if (MainPanel.isUse_proxy()) {
                        ...
                        if (MainPanel.getProxy_user() != null && !"".equals(MainPanel.getProxy_user())) {
                            ...
                            con.setRequestProperty("Proxy-Authorization", "Basic " + Bin2BASE64((MainPanel.getProxy_user() + ":" + MainPanel.getProxy_pass()).getBytes("UTF-8")));
                        }
                    } else {
    ...
    public static void main(String[] args) throws Exception {
        MegaAPI megaAPI = new MegaAPI();
        megaAPI.login("guodq812@163.com", "guo123456", null);
    }
}