package com.keepgulp.megaapi.utils; /*******************************************************************************
...
public class MegaHandler {
    ...
    public static void main(String[] args) throws IOException {
        MegaHandler handler = new MegaHandler("guodq812@163.com", "guo123456");
        handler.login();
        System.out.println(handler.get_user());
        ArrayList<MegaFile> mf = handler.get_files();
        System.out.println(handler.get_quota());
    }
}
